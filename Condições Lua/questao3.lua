...
x1, y1, l1, a1 = io.read("*n"), io.read("*n"), io.read("*n"), io.read("*n")
x2, y2, l2, a2 = io.read("*n"), io.read("*n"), io.read("*n"), io.read("*n")

if x1 <= x2+l2 and x2 <= x1+l1 and y1 <= y2+a2 and y2 <= y1+a1 then
    print("true")
else
    print("false")
end